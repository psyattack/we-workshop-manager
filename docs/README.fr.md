...
- [ ] Dialogues blancs lors du nettoyage des filtres
...
- [ ] Optimisation de l'interface pour différentes tailles et formats d'écran + capacité de redimensionnement de fenêtre
