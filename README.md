...
- [ ] Автозапуск
- [ ] Темы\вид UI
- [ ] Сворачивание в трей без потребления ресурсов
- [ ] Полная замена WE (Редактор пресетов, создание плейлистов, профили и тд.)
- [ ] Автоматическое обновление
- [ ] Смена локализации без перезапуска
- [ ] Доработка полной функциональной идентичности Workshop с оригиналом
- [ ] Оптимизация интерфейса под разные размеры и форматы дисплея
