...
- [ ] Автозапуск (Useless so far)
- [ ] Сворачивание в трей без потребления ресурсов (Useless so far)
- [ ] Полная замена WE (Редактор пресетов, создание плейлистов, профили и тд.) (Useless so far)
- [ ] Автоматическое обновление (Useless so far)
- [ ] Темы\вид UI
- [ ] Доработка полной функциональной идентичности Workshop Tab с оригиналом
